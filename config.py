...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002373209207"))
# NAMA OWNER
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://tryayushsatwase:wdcWo8Tk4yUqfrCz@cluster0.gkgzk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002335115958')) #Log channel id ( make sure bot is admin )

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002062932235"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001987301397"))
...
try:
    ADMINS=[6236064398]
    for x in (os.environ.get("ADMINS", "1320512571").split()):
        ADMINS.append(int(x))
except ValueError:
