...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7829915423:AAHVLAQ-lPteqIazuU9oVi-7rlyPZ3xsTno")
APP_ID = int(os.environ.get("APP_ID", "26732044")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "5afd047f80de08a13039b84153240883") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002055979044")) #Your db channel Id
OWNER = os.environ.get("OWNER", "ayushsatvase") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "1320512571")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://tryayushsatwase:tryayushsatwase@cluster0.enkxvfs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
